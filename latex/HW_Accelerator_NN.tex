...
~insert picture FMA Unit, insert Section Microsoft FPGA
% insert picture FMA Unit.

\section{ASIC}
An Application-specific integrated circuit (ASIC) shares many similiarities with a FPGA. The most notable difference is that while FPGAs can be reprogrammed after production, that is not the case for ASICs. They are however more efficient and provide more functionality. 

~insert Section Google TPU.
