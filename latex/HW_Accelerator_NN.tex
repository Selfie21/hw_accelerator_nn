...
%TODO: Short explanation Systolic ARRAY 
...
%include table results A100, TPU etc.
NVIDIA had 85% of the submission, which include a lot of different Variants of their A100 GPU and others \cite{mlperfresults}. The NVIDIA A100 performs the best for both training and inference phase Per-Accelerator. Google has the Max Scale Record with 4096 units of their TPUv3. In comparison the latest version Intel Processor takes x times the amount of .
